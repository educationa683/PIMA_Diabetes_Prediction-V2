...
Xtrain_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V2/Xtrain.csv"                    # enter the Hugging Face username here
Xtest_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V2/Xtest.csv"                      # enter the Hugging Face username here
ytrain_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V2/ytrain.csv"                    # enter the Hugging Face username here
ytest_path = "hf://datasets/LearnGenAI765/PIMA-Diabetes-Prediction-V2/ytest.csv"                      # enter the Hugging Face username here
...
repo_id = "LearnGenAI765/PIMA-Diabetes-Prediction-V2"                                         # enter the Hugging Face username here
repo_type = "model"
